...
AFRAME.registerComponent("markerhandler", {
  init: async function () {
    ...
    this.el.addEventListener("markerFound", () => {
      ...
      // Alterando a Visibilidade do Componente
      ...
      // Alterando a Visibilidade do Atom
  ...
  //Calcule a distância entre a posição de dois marcadores
  ...
  getCompounds: function () {
    // OBSERVAÇÃO: Use o servidor ngrok para obter os valores json
